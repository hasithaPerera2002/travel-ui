...
$(document).ready(async function () {
  ...
  let hotels = await fetch(
    "http://localhost:8000/api/v1/hotels/getAll",
    requestOptions
  );
...
$("#addHotelButton").click(function (event) {
  ...
  if (validateForm()) {
    ...
    formdata.append(
      "hotelAddress",
      $('#hotelForm input[name="address"]').val()
    );
    formdata.append(
      "hotelStarRating",
      $('#hotelForm input[name="rating"]').val()
    );
    formdata.append(
      "doubleFullBoardPrice",
      $('#hotelForm input[name="doubleFull"]').val()
    );
    formdata.append(
      "doubleHalfBoardPrice",
      $('#hotelForm input[name="doubleHalf"]').val()
    );
    formdata.append(
      "tripleFullBoardPrice",
      $('#hotelForm input[name="tripleFull"]').val()
    );
    formdata.append(
      "tripleHalfBoardPrice",
      $('#hotelForm input[name="tripleHalf"]').val()
    );
    ...
    formdata.append(
      "cancelAllowed",
      $('input[name="cancelAllowed"]:checked').length > 0
    );
    formdata.append(
      "petAllowed",
      $('input[name="petAllowed"]:checked').length > 0
    );
    formdata.append(
      "hotelContact1",
      $('#hotelForm input[name="contact"]').val()
    );
    formdata.append(
      "hotelContact2",
      $('#hotelForm input[name="contact2"]').val()
    );
    ...
    fetch("http://localhost:8000/api/v1/hotels/save", requestOptions)
...
function validateForm() {
  ...
  const hotelImage = $(
    '#hotelForm input[type="file"][name="hotelImage"]'
  ).val();
  ...
  if (
    parseFloat(doubleFull) <= 0 ||
    isNaN(doubleFull) ||
    doubleFull.trim() === ""
  ) {
    $('#hotelForm input[name="doubleFull"]')
      .next(".error-message")
  ...
  if (
    parseFloat(doubleHalf) <= 0 ||
    isNaN(doubleHalf) ||
    doubleHalf.trim() === ""
  ) {
    $('#hotelForm input[name="doubleHalf"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    parseFloat(tripleFull) < 0 ||
    isNaN(tripleFull) ||
    tripleFull.trim() === ""
  ) {
    $('#hotelForm input[name="tripleFull"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    parseFloat(tripleHalf) < 0 ||
    isNaN(tripleHalf) ||
    tripleHalf.trim() === ""
  ) {
    $('#hotelForm input[name="tripleHalf"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#hotelForm input[name="longitude"]')
      .next(".error-message")
      .text("Longitude is not valid");
    return false;
  } else {
  ...
  if (parseFloat(latitude) < 0 || isNaN(latitude) || latitude.trim() === "") {
    $('#hotelForm input[name="latitude"]')
      .next(".error-message")
      .text("Latitude is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#hotelForm input[name="rating"]')
      .next(".error-message")
      .text("Rating is not valid between 5 and 1");
...
function deleteHotel(id) {
  ...
  $("#confirmDelete").on("click", function () {
    ...
    fetch(`http://localhost:8000/api/v1/hotels/delete?id=${id}`, requestOptions)
      .then(function (response) {
        if (response.ok) {
...
const validateUpdateForm = () => {
  ...
  const hotelImage = $('#updateHotelForm input[name="updateHotelImage"]')[0]
    .files[0];

  if (name.trim() === "") {
    $('#updateHotelForm input[name="name"]')
      .next(".error-message")
      .text("Name cannot be empty");
  ...
  if (contact.trim() === "") {
    $('#updateHotelForm input[name="contact"]')
      .next(".error-message")
      .text("Contact cannot be empty");
  ...
  if (
    ...
    $('#updateHotelForm input[name="doubleFull"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#updateHotelForm input[name="doubleHalf"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#updateHotelForm input[name="tripleFull"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#updateHotelForm input[name="tripleHalf"]')
      .next(".error-message")
      .text("Price is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#updateHotelForm input[name="longitude"]')
      .next(".error-message")
      .text("Longitude is not valid");
    return false;
  } else {
  ...
  if (parseFloat(latitude) < 0 || isNaN(latitude) || latitude.trim() === "") {
    $('#updateHotelForm input[name="latitude"]')
      .next(".error-message")
      .text("Latitude is not valid");
    return false;
  } else {
  ...
  if (
    ...
    $('#updateHotelForm input[name="rating"]')
      .next(".error-message")
      .text("Rating is not valid between 5 and 1");
  ...
  if (!hotelImage) {
    $('#updateHotelForm input[name="updateHotelImage"]')
      .next(".error-message")
      .text("Hotel image is required");
  ...
  if (!validateEmail(email)) {
    console.log("email");
    $('#updateHotelForm input[type="email"]')
      .next(".error-message")
      .text("not a valid email");
...
function setData(id) {
  hotelList.forEach((data) => {
    if (data.hotelId === id) {
      ...
      $('#updateHotelForm input[name="doubleFull"]').val(
        data.doubleFullBoardPrice
      );
      $('#updateHotelForm input[name="doubleHalf"]').val(
        data.doubleHalfBoardPrice
      );
      $('#updateHotelForm input[name="tripleFull"]').val(
        data.tripleFullBoardPrice
      );
      $('#updateHotelForm input[name="tripleHalf"]').val(
        data.tripleHalfBoardPrice
      );
      ...
      $('#updateHotelForm input[name="cancelAllowed"]').prop(
        "checked",
        data.cancelAllowed
      );
      $('#updateHotelForm input[name="petAllowed"]').prop(
        "checked",
        data.petAllowed
      );
...
function updateHotel(id) {
  ...
  $("#updateHotel").click(function (event) {
    ...
    if (validateUpdateForm()) {
      ...
      formdata.append(
        "hotelName",
        $('#updateHotelForm input[name="name"]').val()
      );
      formdata.append("hotelAddress", $("#updateAddress").val());
      formdata.append(
        "hotelStarRating",
        $('#updateHotelForm input[name="rating"]').val()
      );
      formdata.append(
        "doubleFullBoardPrice",
        $('#updateHotelForm input[name="doubleFull"]').val()
      ...
      formdata.append(
        "longitude",
        $('#updateHotelForm input[name="longitude"]').val()
      );
      formdata.append(
        "latitude",
        $('#updateHotelForm input[name="latitude"]').val()
      );
      ...
      formdata.append(
        "hotelContact1",
        $('#updateHotelForm input[name="contact"]').val()
      );
      formdata.append(
        "hotelContact2",
        $('#updateHotelForm input[name="contact2"]').val()
      );
      formdata.append("category", $("#updateCategory").val());
      formdata.append(
        "hotelEmail",
        $('#updateHotelForm input[type="email"]').val()
      );
      formdata.append(
        "hotelImage",
        $('#updateHotelForm input[name="updateHotelImage"]')[0].files[0]
      );
      ...
      fetch(
        `http://localhost:8000/api/v1/hotels/update?id=${id}`,
        requestOptions
      )
        .then(function (response) {
          if (response.ok) {
