...
$(document).ready(async function fetchData() {
  ...
  try {
    var headers = {};
    const response = await fetch("http://localhost:8080/api/v1/package/all", {
      method: "GET",
      mode: "cors",
      headers: headers,
    });
    ...
    data.data.forEach((element) => {
      ...
      var innerHTML = `
        <div class="col-md-10 card h-100"
          ...
          <button class="btn button z-2" onclick="handleCard(${element.placeId})">Book</button>
          <div class="video z-2 ">
